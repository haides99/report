...
import me.quanli.report.entity.SendEmail;
...
public class ReportController extends CustomizedRestController {
    ...
    public PageData<Map<String, Object>> getExecutionResultInPage(
            Integer reportId, String params, Long offset, Long limit)
            throws IOException {
    ...
    public String sendEmailWithExecutionResultInXlsx(Integer reportId,
        ...
        List<SendEmail> sendEmails = reportDao
        ...
        for (SendEmail sendEmail : sendEmails) {
            toRecipients.add(sendEmail.getEmailAddress());
        }
